        ...
        <Box w='100%' padding='3' marginTop={-3}>
          ...
          <Actionsheet isOpen={isOpen} onClose={onClose}>
            <Actionsheet.Content _dragIndicator={{
              ...
              <Actionsheet.Item>
                ●  Certidão de casamento com averbação da separação ou divórcio atualizada (expedida até 90 dias);
              </Actionsheet.Item>
              <Actionsheet.Item>
                ●  Sentença judicial ou escritura pública de divórcio ou separação com a fixação de pensão alimentícia em benefício do ex-cônjuge ou   RG e CPF do(a) ex-cônjuge (frente e verso);
              </Actionsheet.Item>
              <Actionsheet.Item>
